...
using Inflectra.SpiraTest.IDEIntegration.VisualStudio2012.Forms.ToolKit.PropertyGrid.Attributes;
using Inflectra.SpiraTest.IDEIntegration.VisualStudio2012.Forms.ToolKit.PropertyGrid.Commands;
using Inflectra.SpiraTest.IDEIntegration.VisualStudio2012.Forms.ToolKit.PropertyGrid.Editors;

namespace Inflectra.SpiraTest.IDEIntegration.VisualStudio2012.Forms.ToolKit.PropertyGrid.Implementation
{
	internal class DescriptorPropertyDefinitionBase : DependencyObject, IPropertyDefinition, IPropertyParent
	{
		...
		{
			string uriPrefix = "/WPFFormats;component/PropertyGrid/Images/";
