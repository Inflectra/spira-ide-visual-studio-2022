...
namespace Inflectra.SpiraTest.IDEIntegration.VisualStudio2012.Forms.ToolKit.Core
{
	internal static class ErrorMessages
	{
		...
		{
			_resourceManager = new ResourceManager("Inflectra.SpiraTest.IDEIntegration.VisualStudio2012.Forms.Toolkit.Core.ErrorMessages", typeof(ErrorMessages).Assembly);
		}
